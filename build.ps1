...
(Get-Content ./client/README.md).replace(' automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project', " for the [Cloudmersive Document and Data Conversion API](https://www.cloudmersive.com/cdr-api)") | Set-Content ./client/README.md
