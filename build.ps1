...
(Get-Content $nuspecpath).replace('<dependencies>', "<projectUrl>https://cloudmersive.com/content-disarm-and-reconstruction-cdr-api</projectUrl><dependencies>") | Set-Content $nuspecpath
