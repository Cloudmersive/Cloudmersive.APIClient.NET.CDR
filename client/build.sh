...
${nuget_cmd} install src/Cloudmersive.APIClient.NET.CDR/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Cloudmersive.APIClient.NET.CDR.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Cloudmersive.APIClient.NET.CDR.dll \
-recurse:'src/Cloudmersive.APIClient.NET.CDR/*.cs' \
-doc:bin/Cloudmersive.APIClient.NET.CDR.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Cloudmersive.APIClient.NET.CDR.dll was created successfully"
fi
